...
my_list = [-abs(i) for i in range(11)]
print(my_list)
...
non_vowels = [e for e in teststring if e != "a" and e != "e" and e != "i" and e != "o" and e != "u"]
print(non_vowels)
...
consonants = [e for e in sentence if e != "a" and e != "e" and e != "i" and e != "o" and e != "u" ]
print(consonants)
